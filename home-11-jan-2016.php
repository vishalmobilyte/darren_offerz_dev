	...
	<div class="row">
		...
		<!-- ============================= SEND OFFERZ TO TEAM ENDS =========================== -->
				...
				<?php 
					...
					$team_id_selected = $offer_data['id'];
		...
		<div class="panel panel-default"> 
						...
						<div class="panel-heading bottom_accordion offer_row">
							...
							<div class="row">
								...
								<div class="col-md-1 col-sm-1">
									<a class="panel-title collapsed" data-toggle="collapse" data-parent="#panel-527391_<?php echo $team_id_selected;?>" href="#panel-element-260016zzz_<?php echo $team_id_selected;?>">
									<i class="fa fa-bars"></i>
									</a>
									<a href="javascript:void(0);" offer_id = "<?php echo $team_id_selected;?>" onclick="remove_offer(this);" style="color:red;" title="Delete Offer">
									<i class="fa fa-remove"></i>
									</a>
								</div>
							</div>
						</div>
						<div id="panel-element-260016zzz_<?php echo $team_id_selected;?>" class="panel-collapse collapse">
							<div class="panel-body">
				...
				<form role="form" action="process/update_offer.php" method="POST" enctype="multipart/form-data" id="form_offer_update">
					<div class="col-md-6 col-sm-6">
						...
						<p class="add_photo" onclick="update_pic(this);"><span id="add_image_offer">ADD PHOTO</span><span class="right_nmbr chars">140</span></p>
					...
					<div class="col-md-3 col-sm-3">
						<h3>CHOOSE TEAM</h3>
							...
							<div class="radio">
							<?php
							$checked = $team_id==$team_id_selected?"checked":"";?>
							  <label class="text_radio_b"><input type="radio" required disabled="disabled" checked="<?php $checked; ?>"  value="<?php echo $team_id; ?>" name="team_id"/><?php echo $team_name; ?></label>
							</div>
							<?php } ?>
					</div>
					...
					<div class="col-md-3 col-sm-3">
						...
						setTimeout(function(){
						$(".datepicker").datepicker('setDate', '01/26/2014'); // Set Date of offer in datepicker.
						},3000);
						});
						</script>
					</div>
