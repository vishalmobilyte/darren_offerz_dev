...
include('process/update_subc.php');
?>
        <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js"></script>
        <script type="text/javascript" src="https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/jquery.validate.min.js"></script>
        <script type="text/javascript" src="https://js.stripe.com/v1/"></script>
        <script type="text/javascript">
          Stripe.setPublishableKey('pk_test_bFubBv10bNTCUP6RYvzWryaW');
    ...
    <body>
        ...
        <form action="" method="post" id="example-form" style="display: none;">
            ...
            <div class="form-row">
                <label for="name" class="stripeLabel">Your Plan</label>
                <label for="name" class="stripeLabel"><?php echo @$plan_name;?></label>
            ...
            <div class="form-row">
                ...
                <input type="hidden" id="client_id" name="client_id" value="<?php echo $id; ?>" class="required" />
            </div>            
