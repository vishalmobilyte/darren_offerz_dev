...
if(!isset($_SESSION['user_id']) && $_SESSION['user_id'] == '' && $_SESSION['user_role'] != "2"){
?>
      <script type="text/javascript">
         <!--
          var url = "<?Php echo SITE_URL; ?>";
               window.location=url+"/admin/login.php?msg=failed";
...
<div class="container">
	<div class="row Under_Armour">
		<div class="col-md-12">
			...
			<?php } else {?>
				<img alt="" class="img-responsive f_l x_img" src="<?php echo SITE_URL;?>img/img_x.png">
			<?php } ?>
		...
		<div class="col-md-12">
			...
			<img alt="" class="img-responsive f_l x_img" src="<?php echo SITE_URL;?>img/setting.png" onclick="toggle_profile_div();">
			<p class="edit_prfile" onclick="toggle_profile_div();">EDIT PROFILE<a href=""></a></p>
			
		</div>
	</div>
	<div class="row Under_Armour" id="profile_div">
	<img alt="" class="img-responsive f_r" src="<?php echo SITE_URL;?>img/cross.png" onclick="toggle_profile_div();">
		<div class="col-md-12">
				...
				<div class="input-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-7 twitter_form">
								<img alt="" class="img-responsive f_l x_img" src="<?php echo SITE_URL;?>img/twitter.png">
								<p class="twitter">
								<?php
								if($get_user_data['twitter_id'] != ''){   ?>
								<a href="<?php echo SITE_URL; ?>unlink_twt.php" >UNLINK TWITTER</a>
								
								<?php } else {?>
								<a href="<?php echo SITE_URL; ?>connect_twitter.php" target="blank" >LINK TWITTER</a>
								<?php } ?>
								</p>
							</div>
						</div>
							...
							<div class="panel-body">
								<div class="row t_members">
									<div class="col-md-12">
										...
										<div class="col-md-6 col-sm-6">
											<!-- <div class="col-md-4 col-sm-4"><img alt="" class="img-responsive f_c" src="<?php echo SITE_URL;?>img/img_1.png"><p class="img_text">Lorea Ipsum</p></div> -->
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-md-2 col-sm-2">
									<p class="acrdion_text">95,302<br><span class="scl_text2">TWEETS</span></p>
								</div>
								<div class="col-md-2 col-sm-2">
									<p class="acrdion_text">265,726<br><span class="scl_text2">FOLLOWERS</span></p>
								</div>
								<div class="col-md-2 col-sm-2">
									<p class="acrdion_text">49,663<br><span class="scl_text2">RETWEETS</span></p>
								</div>
								<div class="col-md-2 col-sm-2">
									<p class="acrdion_text">49,663<br><span class="scl_text2">FAVORITES</span></p>
								</div>
							...
							<div class="panel-body">
								<div class="row t_members">
									<div class="col-md-12">
										...
										<div class="col-md-4 col-sm-4"><img alt="" class="img-responsive f_c" src="<?php echo SITE_URL;?>img/img_1.png"><p class="img_text"><?php echo $team_member['email']; ?></p></div>
										<?php } ?>
			...
			<div class="col-md-12 editable_user">
				...
				<form role="form" action="process/create_offer.php" method="POST" enctype="multipart/form-data">
					<div class="col-md-6 col-sm-6">
						...
						<div id="preview">
						<img alt="No Image" class="img-responsive f_l gallery_img" src="<?php echo SITE_URL;?>img/gallery.png">
						</div>
		...
		<div class="panel panel-default"> 
						<div class="panel-heading bottom_accordion">
							<div class="row">
								...
								<div class="col-md-3 col-sm-3">
									<p class="acrdion_text">12,634,537<br><span class="scl_text2">FOLLOWERS</span></p>
								</div>
								<div class="col-md-3 col-sm-3">
									<p class="acrdion_text">49,663<br><span class="scl_text2">RETWEETS</span></p>
								</div>
...
?>
  ...
  <script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
   <script src="<?php echo SITE_URL; ?>js/jquery_upload_multiple.js"></script>
   <script src="<?php echo SITE_URL; ?>js/ajax_image.js"></script>
<script>
