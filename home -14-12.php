			...
			<div class="col-md-12 editable_user">
				...
				<form role="form" action="process/create_offer.php" method="POST" enctype="multipart/form-data">
					<div class="col-md-6 col-sm-6">
						...
						<textarea  class="form-control custom-control" rows="3" name="editable_text" maxlength="140"></textarea>  
						<h5>Not EDITABLE BY USER</h5>
						<textarea  class="form-control custom-control" rows="3" name="not_editable_text" maxlength="140" onkeyup="check_word_len(this);"></textarea>  
						<div id="preview">
